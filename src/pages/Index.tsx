  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4">
      ...
      <div className="flex flex-col items-center text-center">
        {/* Name */}
        <h1 className="mb-4 text-5xl font-bold tracking-tight text-foreground sm:text-6xl md:text-7xl lg:text-8xl">
          MARIA SILVA
        </h1>
        ...
        <div className="flex items-center gap-6 sm:gap-8">
          ...
          />
          <SocialButton
            href="mailto:contato@mariasilva.com"
            icon={<Mail className="h-7 w-7 sm:h-8 sm:w-8" />}
            label="Email"
          />
          <SocialButton
            href="https://mariasilva.com"
